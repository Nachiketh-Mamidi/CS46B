...
public class MissionOrganizer implements Iterable<Mission>
{
	...
	MissionOrganizer()
	{
		...
		cheapMissions = new ArrayList<>();
		expensiveMissions = new TreeSet<>();
	}
	...
	{
		for (Mission a : cheapMissions) {
			if (a.equals(m)) {
				return true;
			}
		}
		for (Mission b : expensiveMissions) {
			if (b.equals(m)) {
				return true;
			}
		}
	...
	public Iterator<Mission> iterator()
	{
		...
		result.addAll(cheapMissions);
		result.addAll(expensiveMissions);
	...
	private final static Mission[]		TEST_MISSIONS =
	{
        ...
        //added= cheap missions
        new Mission("TestMission1", 1.0E8f),
        new Mission("TestMission2", 2.0E8f),
        
        //added = expensive missions
        new Mission("TestMission3", 12E11f),
        new Mission("TestMission4", 13E11f),
	};
